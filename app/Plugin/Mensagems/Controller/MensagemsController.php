    ...
    class MensagemsController extends AppController{
        ...
        public function index($status = null){
			if($status == null){
				...
				$conditions = array('Mensagem.lida'=>$status);
			}          
            $this->set('contatos', $this->Mensagem->find('all',array('conditions'=>$conditions,'order'=>array('id'=>'DESC'))));
        ...
        public function view($id){
            ...
            if($id){
				...
				$this->Mensagem->save(array('Mensagem'=>array('id'=>$id,'lida'=>'lida')));
			}
        }
